...
/* Simulation assuming stationary initial conditions for the GDP process*/
simulate ,  saving("$project/appendix/mcarlo_gmm_stat_0963", replace) reps(`repsMC') seed(12345): mcsimul, stationary(1) dimT(146) dimN(175) period(104) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
...
/* Imposes persistence of 0.97*/
local true_ar1=`true_ar1'*0.97/`true_persist'
local true_ar2=`true_ar2'*0.97/`true_persist'
local true_ar3=`true_ar3'*0.97/`true_persist'
local true_ar4=`true_ar4'*0.97/`true_persist'
local true_persist=0.97
local true_longest=`true_beta'/(1-`true_persist')
simulate ,  saving("$project/appendix/mcarlo_gmm_stat_097", replace) reps(`repsMC') seed(12345): mcsimul, stationary(1) dimT(146) dimN(175) period(104) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
gen rel_bias_pers=-1+_b_persistence/`true_persist'
gen rel_bias_short=-1+_b_shortrun/`true_beta' 
gen rel_bias_tstat=-1+_b_shortrun_t/`true_beta_t' 
gen rel_bias_longrun=-1+_b_longrun/`true_longest'
...
/* Imposes persistence of 0.98*/
local true_ar1=`true_ar1'*0.98/`true_persist'
local true_ar2=`true_ar2'*0.98/`true_persist'
local true_ar3=`true_ar3'*0.98/`true_persist'
local true_ar4=`true_ar4'*0.98/`true_persist'
local true_persist=0.98
local true_longest=`true_beta'/(1-`true_persist')
simulate ,  saving("$project/appendix/mcarlo_gmm_stat_098", replace) reps(`repsMC') seed(12345): mcsimul, stationary(1) dimT(146) dimN(175) period(104) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
gen rel_bias_pers=-1+_b_persistence/`true_persist'
gen rel_bias_short=-1+_b_shortrun/`true_beta' 
gen rel_bias_tstat=-1+_b_shortrun_t/`true_beta_t' 
gen rel_bias_longrun=-1+_b_longrun/`true_longest'
...
/* Imposes persistence of 0.99*/
local true_ar1=`true_ar1'*0.99/`true_persist'
local true_ar2=`true_ar2'*0.99/`true_persist'
local true_ar3=`true_ar3'*0.99/`true_persist'
local true_ar4=`true_ar4'*0.99/`true_persist'
local true_persist=0.99
local true_longest=`true_beta'/(1-`true_persist')
simulate ,  saving("$project/appendix/mcarlo_gmm_stat_099", replace) reps(`repsMC') seed(12345): mcsimul, stationary(1) dimT(146) dimN(175) period(104) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
gen rel_bias_pers=-1+_b_persistence/`true_persist'
gen rel_bias_short=-1+_b_shortrun/`true_beta' 
gen rel_bias_tstat=-1+_b_shortrun_t/`true_beta_t' 
gen rel_bias_longrun=-1+_b_longrun/`true_longest'
