...
simulate ,  saving("$project/appendix/mcarlo_wg_nstat_097", replace) reps(`repsMC') seed(12345): mcsimul, stationary(0) dimT(46) dimN(175) period(4) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
gen rel_bias_pers=-1+_b_persistence/`true_persist'
gen rel_bias_short=-1+_b_shortrun/`true_beta' 
gen rel_bias_tstat=-1+_b_shortrun_t/`true_beta_t' 
gen rel_bias_longrun=-1+_b_longrun/`true_longest'
...
local true_longest=`true_beta'/(1-`true_persist')
simulate ,  saving("$project/appendix/mcarlo_wg_nstat_098", replace) reps(`repsMC') seed(12345): mcsimul, stationary(0) dimT(46) dimN(175) period(4) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
gen rel_bias_pers=-1+_b_persistence/`true_persist'
gen rel_bias_short=-1+_b_shortrun/`true_beta' 
gen rel_bias_tstat=-1+_b_shortrun_t/`true_beta_t' 
gen rel_bias_longrun=-1+_b_longrun/`true_longest'
...
local true_longest=`true_beta'/(1-`true_persist')
simulate ,  saving("$project/appendix/mcarlo_wg_nstat_099", replace) reps(`repsMC') seed(12345): mcsimul, stationary(0) dimT(46) dimN(175) period(4) beta(`true_beta') ar1(`true_ar1') ar2(`true_ar2') ar3(`true_ar3') ar4(`true_ar4') dar1(`true_dar1') dar2(`true_dar2') dar3(`true_dar3') dar4(`true_dar4')  vardem(`true_vardem') vargdp(`true_vargdp') gdpshock(`true_gdpshock') demshock(`true_demshock') gdpinit(`true_gdpinit') deminit(`true_deminit')
gen rel_bias_pers=-1+_b_persistence/`true_persist'
gen rel_bias_short=-1+_b_shortrun/`true_beta' 
gen rel_bias_tstat=-1+_b_shortrun_t/`true_beta_t' 
gen rel_bias_longrun=-1+_b_longrun/`true_longest'
