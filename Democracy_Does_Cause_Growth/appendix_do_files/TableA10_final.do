...
/* democ and rever stand for cumulative democratizations ad cumulative reversals. */
sum democ rever dem

/* Estimates */
xtreg y l(1/4).y democ rever yy*, fe r
estimates store e1
nlcom (shortrun: _b[democ])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e1_democ

estimates restore e1
nlcom (shortrun: _b[rever])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e1_rever

xtreg y l(1/8).y democ rever yy*, fe r
estimates store e2
nlcom (shortrun: _b[democ])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]) (lag5: _b[L5.y]) (lag6: _b[L6.y]) (lag7: _b[L7.y]) (lag8: _b[L8.y]), post
vareffects8
estimates store e2_democ

estimates restore e2
nlcom (shortrun: _b[rever])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]) (lag5: _b[L5.y]) (lag6: _b[L6.y]) (lag7: _b[L7.y]) (lag8: _b[L8.y]), post
vareffects8
estimates store e2_rever

xtabond2 y l(1/4).y democ rever yy* ,  gmmstyle(y, laglimits(2 .)) gmmstyle(democ rever, laglimits(1 1)) ivstyle(yy*, p) noleveleq robust nodiffsargan
estimates store e3
nlcom (shortrun: _b[democ])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e3_democ

estimates restore e3
nlcom (shortrun: _b[rever])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e3_rever

xtabond2 y l(1/8).y democ rever yy* ,  gmmstyle(y, laglimits(2 .)) gmmstyle(democ rever, laglimits(1 1)) ivstyle(yy*, p) noleveleq robust nodiffsargan
estimates store e4
nlcom (shortrun: _b[democ])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]) (lag5: _b[L5.y]) (lag6: _b[L6.y]) (lag7: _b[L7.y]) (lag8: _b[L8.y]), post
vareffects8
estimates store e4_democ

estimates restore e4
nlcom (shortrun: _b[rever])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]) (lag5: _b[L5.y]) (lag6: _b[L6.y]) (lag7: _b[L7.y]) (lag8: _b[L8.y]), post
vareffects8
estimates store e4_rever
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (democ rever L1.y L2.y L3.y L4.y) (y) (democ rever) (yy*), ydeep(1960) ystart(1964) yfinal(2009) truncate(1)
estimates store e5
nlcom (shortrun: _b[democ])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e5_democ

estimates restore e5
nlcom (shortrun: _b[rever])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]), post
vareffects
estimates store e5_rever
...
bootstrap _b, seed(12345) reps(`repsBS') cluster(wbcode2) idcluster(newcl):  hhkBS y (democ rever L1.y L2.y L3.y L4.y L5.y L6.y L7.y L8.y) (y) (democ rever) (yy*), ydeep(1960) ystart(1968) yfinal(2009) truncate(1)
estimates store e6
nlcom (shortrun: _b[democ])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]) (lag5: _b[L5.y]) (lag6: _b[L6.y]) (lag7: _b[L7.y]) (lag8: _b[L8.y]), post
vareffects8
estimates store e6_democ

estimates restore e6
nlcom (shortrun: _b[rever])  (lag1: _b[L.y])  (lag2: _b[L2.y])  (lag3: _b[L3.y])  (lag4: _b[L4.y]) (lag5: _b[L5.y]) (lag6: _b[L6.y]) (lag7: _b[L7.y]) (lag8: _b[L8.y]), post
vareffects8
estimates store e6_rever

/* Export tables */
estout e1 e2 e3 e4 e5 e6  using "$project/appendix/TableDemocVsRever.tex", style(tex) ///
varlabels(democ "Democratizations" rever "Reversals") ///
cells(b(star fmt(%9.3f)) se(par)) ///
stats(N N_g, fmt(%7.0f  %7.0f) ///
labels( "\input{appendix/TableDemocVsRever_Democ}\input{appendix/TableDemocVsRever_Rever} Observations" "Countries in sample" ))  ///
keep(democ rever) order(democ rever) stardrop(democ rever)  ///
nolabel replace mlabels(none) collabels(none)

estout e1_democ e2_democ e3_democ e4_democ e5_democ e6_democ   using "$project/appendix/TableDemocVsRever_Democ.tex", style(tex) ///
varlabels(longrun "Long-run effect of democracy"  effect$limit "Effect of democracy after $limit years") ///
cells(b(star fmt(%9.3f)) se(par)) ///
keep(longrun effect$limit) order(longrun effect$limit) stardrop(longrun effect$limit) /// 
nolabel replace mlabels(none) collabels(none)

estout e1_rever e2_rever e3_rever e4_rever e5_rever e6_rever   using "$project/appendix/TableDemocVsRever_Rever.tex", style(tex) ///
varlabels(longrun "Long-run effect of reversal"  effect$limit "Effect of reversal after $limit years"  persistence "Persistence of GDP process") ///
cells(b(star fmt(%9.3f)) se(par)) ///
keep(longrun effect$limit persistence) order(longrun effect$limit persistence) stardrop(longrun effect$limit persistence)  ///
nolabel replace mlabels(none) collabels(none)
